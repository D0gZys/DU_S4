...
for k, model in enumerate(models):
    ...
    #np.savetxt("/Users/thomasgibelin/PycharmProjects/DUS4/data_0" + str(k) + ".csv", np.array([xs, ys]).T)
    ...
    #plt.savefig("/Users/thomasgibelin/PycharmProjects/DUS4/image" + str(k) + ".png")
    plt.show()